          ...
          <Form className="flex flex-col gap-4 ">
            ...
            <div className="lg:grid lg:grid-cols-2 gap-2">
              <TextField className="w-full" name="password">
                <Label>Password <span className="text-[var(--primary-color)]">*</span></Label>
                <InputGroup>
                  <InputGroup.Input
                  ...
                  />
                  <InputGroup.Suffix className="pr-0 outline-[2.5px] outline-[var(--primary-color)] bg-[var(--bg-color)] ">
                    <Button
              ...
              <TextField className="w-full " name="confirm-password">
                <Label>Confirm Password <span className="text-[var(--primary-color)]">*</span></Label>
                <InputGroup>
                  <InputGroup.Input
                    className="rounded-l-xl"
                    placeholder="Confirm Password"
                    type={isVisible2 ? "text" : "password"}
                    // value={isVisible2 ? "87$2h.3diua" : "••••••••"}
                  />
                  <InputGroup.Suffix className="pr-0 outline-[2.5px] outline-[var(--primary-color)] bg-[var(--bg-color)]">
                    <Button
                      className="bg-[var(--bg-color)]"
            ...
            <div className="lg:grid lg:grid-cols-2 gap-2">
              <div>
                <label htmlFor="tags" className="font-bold">Gender <span className="text-[var(--primary-color)]">*</span></label>
                <TagGroup aria-label="Tags" selectionMode="single">
                  <TagGroup.List>
                    <Tag
                      id="male"
                      className="bg-transparent data-[selected=true]:bg-red-500 mr-6 my-4 text-[var(--text-color)] border-1 border-[var(--primary-color)] py-3 px-5"
                    >
                      Male
                    </Tag>
                    <Tag
              ...
              <div>
               <label htmlFor="dob" className="py-0 inline-block font-bold">Date Of Birth <span className="text-[var(--primary-color)]">*</span></label>
               <input type="date" id="dob" className="p-2 rounded-xl" placeholder="DD/MM/YYYY" />
              </div>
            </div>
            <div className="lg:grid lg:grid-cols-2 gap-2">
                <Select  placeholder="Select Blood Group">
                <label htmlFor="blood-group" className="font-bold ">Blood Group <span className="text-[var(--primary-color)]">*</span></label>
                <Select.Trigger className="bg-[var(--bg-color)] border-1 border-[var(--primary-color)]" >
                    <Select.Value />
                    <Select.Indicator />
                </Select.Trigger>
                <Select.Popover className="bg-[var(--bg-box-color)]">
                    <ListBox>
                    <ListBox.Item id="a+" className="hover:bg-[var(--primary-color)] hover:text-[var(--text-color)]" textValue="A+">
                        A+
                    ...
                    <ListBox.Item id="b+" className="hover:bg-[var(--primary-color)] hover:text-[var(--text-color)]" textValue="B+">
                        B+
                        <ListBox.ItemIndicator />
                    </ListBox.Item>
                    <ListBox.Item id="b-" className="hover:bg-[var(--primary-color)] hover:text-[var(--text-color)]" textValue="B-">
                    ...
                    <ListBox.Item id="ab+" className="hover:bg-[var(--primary-color)] hover:text-[var(--text-color)]" textValue="AB+">
                        AB+
                        <ListBox.ItemIndicator />
                    </ListBox.Item>
                    <ListBox.Item id="ab-" className="hover:bg-[var(--primary-color)] hover:text-[var(--text-color)]" textValue="AB-">
                    ...
                    <ListBox.Item id="o+" className="hover:bg-[var(--primary-color)] hover:text-[var(--text-color)]" textValue="O+">
                        O+
                        <ListBox.ItemIndicator />
                    </ListBox.Item>
                    <ListBox.Item id="o-" className="hover:bg-[var(--primary-color)] hover:text-[var(--text-color)]" textValue="O-">
                ...
                <div className="flex flex-col gap-1">
                    <Label htmlFor="input-type-number" className="font-bold ">Weight (Kg) <span className="text-[var(--primary-color)]">*</span></Label>
                    <Input id="input-type-number" min={0} placeholder="Weight (kg)" type="number" />
                </div>
            </div>
            <div className="lg:grid lg:grid-cols-1 ">
                <label htmlFor="last-donation-date" className="py-0 inline-block font-bold">Last Blood Donation Date <span className="text-[var(--primary-color)]">*</span></label>
               <input type="date" id="last-donation-date" className="p-2 rounded-xl" placeholder="DD/MM/YYYY" />
            </div>
            <div className="lg:grid lg:grid-cols-3 gap-2">
                ...
                <TextField isRequired name="state" type="text">
                    <Label>State</Label>
                    <Input placeholder="State" />
                    <FieldError />
                </TextField>
                <TextField isRequired name="pincode" type="text">
                    <Label>Pincode</Label>
                    <Input placeholder="Pincode" />
                    <FieldError />
                </TextField>
            </div>
            <div className="grid lg:grid lg:grid-cols-1">
                <label htmlFor="address" className="py-0 inline-block font-bold">Address <span className="text-[var(--primary-color)]">*</span></label>
                <TextArea
                    id="address"
                    className="bg-[var(--bg-color)] h-40 border-1 border-[var(--primary-color)] text-[var(--text-color)]"
