...
function UserReg() {
  ...
  return (
    <>
      ...
      <div
        className="relative grid lg:grid-cols-2 bg-cover bg-left bg-no-repeat bg-transparent-500 "
        style={{ backgroundImage: `url(${bgImage})` }}
        >
        <div className="absolute inset-0 bg-black/60"></div>
        <div className=" p-20 w-full relative z-10 hidden lg:block">
          ...
          <Tabs className="w-full">
            <Tabs.ListContainer className="bg-[var(--bg-box-color)]">
              <Tabs.List aria-label="Options">
                <Tabs.Tab id="user" className="text-[var(--text-color)] ">
                  User
                  <Tabs.Indicator className="bg-red-500"/>
                </Tabs.Tab>
                <Tabs.Tab id="hospital" className="text-[var(--text-color)] ">
                  Hospital
                  <Tabs.Indicator className="bg-red-500"/>
                </Tabs.Tab>
                <Tabs.Tab id="blood_bank" className="text-[var(--text-color)] ">
                  Blood Bank
                  <Tabs.Indicator className="bg-red-500"/>
                </Tabs.Tab>
              </Tabs.List>
            </Tabs.ListContainer>
            <Tabs.Panel className="pt-4" id="user">
              <UserRegister/>
            </Tabs.Panel>
